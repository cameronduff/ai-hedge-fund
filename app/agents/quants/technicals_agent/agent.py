...
from app.agents.quants.technicals_agent.prompt import TECHNICALS_PROMPT, TECHNICALS_FORMATTING_PROMPT
...
technicals_quant_agent = LlmAgent(
    ...
    input_schema=Ticker,
    output_key="technicals_agent_raw_output",
)

technicals_formatter_agent = LlmAgent(
    name="technicals_formatter_agent",
    model=settings.REASONING_MODEL,
