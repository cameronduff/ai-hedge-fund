...
def build_peter_lynch_agent() -> SequentialAgent:
    return SequentialAgent(
        name="peter_lynch_boardroom_agent",
        sub_agents=[
            _build_persona(),
            build_investor_formatter_agent("peter_lynch"),
        ],
    )


def build_peter_lynch_debate_agent() -> LlmAgent:
