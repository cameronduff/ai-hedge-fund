...
def _to_json_safe(value):
    ...
    Returns:
        The JSON-serializable version of the value.
    """
...
def get_info_by_ticker(ticker: str):
    ...
    """
    logger.info(f"Calling get_info_by_ticker(ticker='{ticker}')")
...
def get_balance_sheet_by_ticker(ticker: str):
    ...
    Returns:
        str: A JSON string containing the balance sheet data.
    """
    logger.info(f"Calling get_balance_sheet_by_ticker(ticker='{ticker}')")
...
def get_historical_data(ticker: str, period: str = "1mo"):
    ...
    Returns:
        str: A JSON string containing the historical price and volume data.
    """
    logger.info(f"Calling get_historical_data(ticker='{ticker}', period='{period}')")
...
def get_options_chain(ticker: str):
    ...
    Returns:
        str: A JSON string containing the options chain data.
    """
    logger.info(f"Calling get_options_chain(ticker='{ticker}')")
...
def get_quarterly_income_statement(ticker: str):
    ...
    Returns:
        str: A JSON string containing the quarterly income statement data.
    """
    logger.info(f"Calling get_quarterly_income_statement(ticker='{ticker}')")
...
def get_calendar(ticker: str):
    ...
    Returns:
        dict: A dictionary containing the earnings calendar data.
    """
    logger.info(f"Calling get_calendar(ticker='{ticker}')")
...
def get_analyst_price_targets(ticker: str):
    ...
    Returns:
        dict: A dictionary containing analyst price targets.
    """
    logger.info(f"Calling get_analyst_price_targets(ticker='{ticker}')")
