...
def get_account_summary() -> dict:
    ...
    """
    logger.info("Calling get_account_summary()")
...
def get_all_pending_orders() -> dict:
    ...
    Returns:
        dict: A dictionary containing a list of pending orders.
    """
    logger.info("Calling get_all_pending_orders()")
...
def get_pending_order_by_id(id: int) -> dict:
    ...
    Returns:
        dict: A dictionary containing the pending order details.
    """
    logger.info(f"Calling get_pending_order_by_id(id={id})")
...
def get_all_available_instruments() -> dict:
    ...
    Returns:
        dict: A dictionary containing all available instruments.
    """
    logger.info("Calling get_all_available_instruments()")
...
def fetch_all_open_positions(query: dict | None = None) -> dict:
    ...
    """
    logger.info(f"Calling fetch_all_open_positions(query={query})")
...
def place_limit_order(payload: LimitOrderPayload) -> dict:
    ...
    Returns:
        dict: A dictionary containing the response from the order placement.
    """
    logger.info(f"Calling place_limit_order(payload={payload})")
...
def place_market_order(payload: MarketOrderPayload) -> dict:
    ...
    Returns:
        dict: A dictionary containing the response from the order placement.
    """
    logger.info(f"Calling place_market_order(payload={payload})")
...
def place_stop_order(payload: MarketOrderPayload) -> dict:
    ...
    Returns:
        dict: A dictionary containing the response from the order placement.
    """
    logger.info(f"Calling place_stop_order(payload={payload})")
...
def place_stop_limit_order(payload: StopLimitOrderPayload) -> dict:
    ...
    Returns:
        dict: A dictionary containing the response from the order placement.
    """
    logger.info(f"Calling place_stop_limit_order(payload={payload})")
...
def cancel_pending_order(id: int) -> dict:
    ...
    Returns:
        dict: A dictionary containing the response from the cancellation request.
    """
    logger.info(f"Calling cancel_pending_order(id={id})")
